...
exports.Drone = Drone = {
  insert: (aNumber, aType, aAirOperatorName, aBaseName, aAvailability = 0, aGeneralState = 'OK', aLastMaintenance = undefined, aFligthTimeSinceLastMaintenance = undefined, aNotes = undefined, aMissionsCompleted = [], aMissionsWaitingForQtb = []) => {
    AirOperator.findByName(aAirOperatorName, '_id', (err, aAirOperator) => {
      Base.findByName(aBaseName, '_id', (err, aBase) => {
        new models.Drone({
          _id: mongoose.Types.ObjectId(),
